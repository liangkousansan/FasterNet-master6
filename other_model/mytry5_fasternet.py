...
class GroupConv(nn.Module):
    ...
    def forward(self, x):
        ...
        tmp = tmp.permute(1, 0, 2)  # 对tensor维度进行转置
        tmp = tmp.reshape(channels, b*w*h)

        tmp_T = tmp.transpose(1,0)
        co = tmp.mm(tmp_T) # 两矩阵相乘
...
class MLPBlock(nn.Module):
    ...
    def __init__(self,
        ...
        mlp_layer: List[nn.Module] = [
            ...
            GroupConv(dim, dim, featuremap_size, 16),
            GroupBillinear(16, featuremap_size, dim),
    ...
    def __init__(self,
        ...
        blocks_list = [
            MLPBlock(
                ...
                featuremap_size=featuremap_size # DBTNet网络中的
            )
...
class FasterNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 featuremap_size=224,  # DBTNet网络中的
                 **kwargs):
        super().__init__()
        ...
        if self.fork_feat:
            ...
            #我加的
            #self.head = nn.Linear(num_classes, 2)
            self.add_module('add_linear', nn.Linear(1000, 10))
            #我加的到这里
