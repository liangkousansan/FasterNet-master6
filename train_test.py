...
def main(args):
    ...
    if args.checkpoint_path is not None:
        ...
        if PATH[-5:]=='.ckpt':
            ...
            missing_keys, unexpected_keys = model.model.load_state_dict(torch.load(PATH, map_location=torch.device('cpu')), False)
            # show for debug
    ...
    trainer = pl.Trainer(
        ...
        gpus=args.gpus,
        accelerator="cpu",# 我改成了cpu,本来是gpu,改成 precision='bf16'
        #precision='bf16',
        ...
        callbacks=callbacks,
        precision='bf16', # 我也改成了'bf16'，原来的args.precision
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default="./model_ckpt/fasternet_t0-epoch.281-val_acc1.71.9180.pth") #本来是default=none,我改了
