...
class custom_ImagenetDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.num_workers = 0#这里我将num_workers改成了0
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage == "test" or stage is None:
            ...
            print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@:")  # 我加的,输出是data/imagenet/val，应该没问题啊
            print(datasets.ImageFolder(os.path.join(self.data_dir, 'val'), transform=val_transforms))  # 我加的
